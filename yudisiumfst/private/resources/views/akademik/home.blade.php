              ...
              <div class="row">
                        <div class="col-lg-3 col-xs-6">
                          ...
                          <div class="small-box bg-orange">
                            ...
                            <a href="{{ url('inputnoijazah') }}" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                          </div>
                        </div><!-- ./col -->
                        ...
                        <div class="col-lg-3 col-xs-6">
                          ...
                          <div class="small-box bg-green">
                            ...
                            <a href="{{ url('datawisudawanak') }}" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                          </div>
                        </div><!-- ./col -->
                        ...
                        <div class="col-lg-3 col-xs-6">
                          ...
                          <div class="small-box bg-blue">
                            ...
                            <a href="{{ url('kelolaakun') }}" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                          </div>
                        </div><!-- ./col -->
