					...
					<!-- <div class="row"> -->
						<!-- <div class="col-sm-12"> -->
							<ul id="myTabs" class="nav nav-pills" role="tablist"> 
								<li role="presentation" class="active"><a href="#biodata" role="tab" id="no" data-toggle="tab" aria-controls="profile" aria-expanded="false" ">Biodata Mahasiswa</a></li> 
								<li role="presentation" class=""><a href="#status" id="yes" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="false" ">Status</a></li>
							</ul>
						<!-- </div> -->
<!-- 						<div class="col-sm-4">
						</div> -->
					...
					<!-- <input class="hidden" value="no" id="file_input" name="file_input"></input> -->
					<div id="myTabContent" class="tab-content" > 
						<div role="tabpanel" class="tab-pane fade " id="status" aria-labelledby="home-tab" > 
								...
								<table class="table table-bordered">
									<thead>
				                      ...
				                      <tr class="color:#339BEB;" style="color:white; background-color:#339BEB;">
				                        <th colspan="4">TRACE & TRACKING</th>
				                      </tr>
				                    </thead>
									@foreach($data as $dataa)
				                    <tr>
										...
										<td width="65%" colspan="2"><span class="label label-warning">Belum diapprove</td>
										@endif
										@if ($dataa->VERIFIKASI == 1)
										<td width="65%" colspan="2"><span class="label label-success">Approved</td>
										@endif
									</tr>
									<tr>
										<td >SKP</td>
										<td >:</td>
										@if (is_null($dataa->SKP))
										<td colspan="2"> <span class="label label-warning">Belum diinput</span></td>
										@else <td colspan="2">{{ $dataa->SKP }}</td>
										@endif
									</tr>
									@endforeach
				                    ...
				                    <tr>
										...
										<td ><span class="label label-success">Sudah diupload </span>
										
										@foreach($data as $dataa)
											@if (is_null(cekPesan($dataa->NIM, $filee->ID_FILE)))
											@else
											<br>
											<p><b style="color:#5cb85c">Pesan : </b> {{ cekPesan($dataa->NIM, $filee->ID_FILE) }}</p> 
											@endif
										@endforeach
										...
										@endif
										@if (cekFile($filee->ID_FILE) != $filee->ID_FILE)
										<td ><span class="label label-warning">Belum diupload </span>
						...
						<div role="tabpanel" class="tab-pane fade active in" id="biodata" aria-labelledby="profile-tab" > 
							...
							<div class="table-responsive">
								<table class="table table-bordered">
									...
									<a style="text-align:center" class="btn btn-success btn-lg btn-block" href="{{ url('printformdatalulusan') }}" target="_blank"><i class="fa fa-print"></i> &nbsp;Print Form Data Lulusan</a>
