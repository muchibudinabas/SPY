    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="{{$url = asset('private/resources/assets/AdminLTE/index2.html')}}" class="logo">
          ...
          <span class="logo-mini"><b class="fa fa-book text-white"></b></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b class="fa fa-book text-white"> Ruang Baca </b></span>
        </a>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="{{ Request::segment(1) === 'daftaranggota' ? 'active' : null }}">
              <!-- <a href="#"> -->
              <a href="{{ url('daftaranggota') }}">
                <i class="fa fa-user "></i> <span> Daftar Anggota </span>
              </a>
            </li>
            <li class="{{ Request::segment(1) === 'pinjambuku' ? 'active' : null }}">
              <a href="{{ url('pinjambuku') }}" id="pinjambuku">
                <i class="fa fa-book "></i>
                <span> Pinjam Buku </span>
              </a>
            </li>
            <li class="{{ Request::segment(1) === 'historypinjambuku' ? 'active' : null }}">
              <a href="{{ url('historypinjambuku') }}">
                <i class="fa fa-book "></i>
                <span> Histori Pinjam Buku </span>
              </a>
            </li>
            <li class="{{ Request::segment(1) === 'cetaksuratbebaspinjam' ? 'active' : null }}">
              <a href="{{ url('cetaksuratbebaspinjam') }}">
                <i class="fa fa-print "></i>
                <span> Cetak Surat Bebas Pinjam </span>
              </a>
            </li>
          </ul>
        </section>
