        ...
        <section class="content">
          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <div class="menufile" style="display: none; margin-top: -20px;">
                ...
                <table class="table table-striped table-bordered">
                  ...
                  <tr class="bg-info">
                    ...
                    <th width="0%">:</th>
                    <th width="67%"><a href="{{ url('private/uploads/files/'.$dataa2->FILE_ALUMNI.'') }}" target="_blank">{{ $dataa2->FILE_ALUMNI }}</a>
                     
                    <a href="{{ url('upload/'.$dataa2->NIM.'/'.$dataa2->ID_FILE.'') }}" class="fa fa-upload" style="float: right;"></a>
                    <a href="{{ url('pesan/'.$dataa2->NIM.'/'.$dataa2->ID_FILE.'') }}" class="fa fa-envelope" style="float: right; margin-right: 10px;"></a>
                    </th>
                  </tr>
                  @endforeach
                </table>
              ...
              <a class="btn btn-default btn-md btn-block" href="{{ url('approve') }}">Back</a>
              @endif
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          ...
                          @foreach ($data as $dataa)
                          <a class="btn btn-success" id="ApproveButton" href="{{ url('approvePendaftaran',$dataa->NIM) }}">Approve</a>
                          @endforeach
                        </div>
                    </div>
                  </div>
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                else
                {
                    ...
                    infooo.find('p').append('<strong> Success! </strong> Data berhasil dicancel.');
