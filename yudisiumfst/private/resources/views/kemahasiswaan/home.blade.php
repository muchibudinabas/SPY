              ...
              <div class="row">
                        ...
                        <div class="col-lg-3 col-xs-6">
                          ...
                          <div class="small-box bg-orange">
                            ...
                            <a href="{{ url('inputskp') }}" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                          </div>
                        </div><!-- ./col -->
                        ...
                        <div class="col-lg-3 col-xs-6">
                          ...
                          <div class="small-box bg-green">
                            <div class="inner">
                              ...
                              <h3>{{ $dataa2->verifikasi_count }}</h3>
                              @endforeach
                              <p>Data SKP Mahasiswa</p>
                            </div>
                            <div class="icon">
                              <i class="fa fa-edit"></i>
                            </div>
                            <a href="{{ url('dataskpmahasiswa') }}" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                          </div>
                        </div><!-- ./col -->
                        ...
                        <div class="col-lg-3 col-xs-6">
                          ...
                          <div class="small-box bg-blue">
                            <div class="inner">
                              ...
                              @endforeach
                              <p>Data SKP Wisudawan</p>
                            </div>
                            <div class="icon">
                              <i class="fa fa-mortar-board"></i>
                            </div>
                            <a href="{{ url('datawisudawankm') }}" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                          </div>
                        </div><!-- ./col -->
