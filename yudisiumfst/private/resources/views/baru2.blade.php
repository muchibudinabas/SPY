      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="header" style="font-size: 13px;">PENDAFTARAN YUDISIUM</li>

            <li class="{{ Request::segment(1) === 'approve' ? 'active' : null }}">
              <a href="{{ url('/approve') }}">
                <i class="fa fa-check-square-o "></i> <span> Approve </span>
              </a>
            </li>
            <li class="{{ Request::segment(1) === 'onprocess' ? 'active' : null }}">
              <a href="{{ url('/onprocess') }}">
                <i class="fa fa-spinner "></i> <span> On Process </span>
              </a>
            </li>

            <li class="{{ Request::segment(1) === 'datawisudawan' ? 'active' : null }}">
              <a href="{{ url('/datawisudawan') }}">
                <i class="fa fa-mortar-board "></i>
                <span> Data Wisudawan </span>
              </a>
            </li>
            <li class="header" style="font-size: 13px;">AKUN PENDAFTAR YUDISIUM</li>

            <li class="{{ Request::segment(1) === 'ubahpassword_prodi' ? 'active' : null }}">
              <a href="{{ url('/ubahpassword_prodi') }}">
                <i class="fa fa-key"></i>
            ...
            <!-- <li class="treeview">
              <a href="#">
                <i class="fa fa-edit text-green"></i> <span> Input No Ijazah </span>
              </a>
            </li> -->
          </ul>
        </section>
